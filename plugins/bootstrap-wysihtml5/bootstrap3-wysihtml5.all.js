  ...
  wysihtml5.dom.domNode = function(node) {
    ...
    return {
      ...
      prev: function(options) {
        ...
        if (
          (!wysihtml5.lang.array(types).contains(prevNode.nodeType)) || 
          (options && options.ignoreBlankTexts && _isBlankText(prevNode)) 
        ) {
      ...
      next: function(options) {
        ...
        if (
          (!wysihtml5.lang.array(types).contains(nextNode.nodeType)) || 
          (options && options.ignoreBlankTexts && _isBlankText(nextNode)) 
        ) {
...
wysihtml5.dom.parse = function(elementOrHtml_current, config_current) {
  ...
  function _checkAttributes(oldNode, local_attributes) {
    var globalAttributes  = wysihtml5.lang.object(currentRules.attributes || {}).clone(), 
...
;wysihtml5.dom.compareDocumentPosition = (function() {
  ...
  if (documentElement.compareDocumentPosition) {
    ...
    return function( container, element ) {
      ...
      if( container.nodeType === 2  && container.childNodes && wysihtml5.lang.array(container.childNodes).indexOf( element ) !== -1)
        return 4 + 16; 

      if( element.nodeType === 2  && element.childNodes && wysihtml5.lang.array(element.childNodes).indexOf( container ) !== -1)
        return 2 + 8; 
      ...
      while( point ) {
        ...
        if( location_index !== -1) {
         ...
         var this_index = wysihtml5.lang.array(smallest_common_ancestor.childNodes).indexOf( parents[location_index - 1]);
         var other_index = wysihtml5.lang.array(smallest_common_ancestor.childNodes).indexOf( previous ); 
...
wysihtml5.Commands = Base.extend(
   ...
   * @example
   *    commands.exec("insertImage", "http:
   */
...
;(function(wysihtml5) {
  ...
  wysihtml5.commands.createLink = {
     ...
     * @example
     *    
     *    wysihtml5.commands.createLink.exec(composer, "createLink", "http:
     *    
     *    wysihtml5.commands.createLink.exec(composer, "createLink", { href: "http:
     */
